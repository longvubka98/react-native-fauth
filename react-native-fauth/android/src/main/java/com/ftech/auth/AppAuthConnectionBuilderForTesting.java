 ...
 * only.
 */
final class AppAuthConnectionBuilderForTesting implements ConnectionBuilder {

    static final AppAuthConnectionBuilderForTesting INSTANCE = new AppAuthConnectionBuilderForTesting();
